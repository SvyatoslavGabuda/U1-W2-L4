...
const characters = [];
console.log("prova richiamo", starWarsCharacters[1].name);
/* ESERCIZIO 2
...
// console.log(typeof massatotale);
...
(Tip: puoi creare un nuovo array, o tentare la riassegnazione del valore corrispondente)
*/
console.log(
  "\n -------------------------- Esercizio 8 -------------------------- \n"
);
